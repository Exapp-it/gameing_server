...
@pytest.fixture()
def test_data():
    url = 'http://localhost:8000/api/mancala_service/Credit'
...
def test_Credit_invalid_hash(test_data):
...
def test_Credit_invalid_sessionId(test_data):
    test_data['json']['SessionId'] = 'some id'
...
def test_Credit_invalid_amount(test_data):
...
def test_Credit_normal(test_data):
